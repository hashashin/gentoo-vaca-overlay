...
pkg_postinst() {
	...
	ewarn "If you plan log to mysql you can create a database using:"
	ewarn "/usr/share/doc/"${P}"/"${PN}"_db.sql.bz2"
	ewarn " "
	ewarn "Modify as need /opt/"${PN}"/conf/log-mysql.conf and uncomment"
	ewarn "in /opt/amun/conf/"${PN}".conf log-mysql related lines"
}
